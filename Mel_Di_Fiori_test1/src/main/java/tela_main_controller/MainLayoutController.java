...
public class MainLayoutController {
    ...
    private void configurarUsuarioLogado() {
        // ✅ CONFIGURA O NOME DO USUÁRIO LOGADO NO CABEÇALHO
    ...
    // ✅ NOVO MÉTODO: ABRIR GERENCIAMENTO DE USUÁRIOS (APENAS ADMIN)
    @FXML
    public void abrirGerenciamentoUsuarios() {
        ...
        carregarTela("/telas/view/TelaGerenciamentoUsuarios.fxml");
    }
    ...
    private void mostrarAlertaAcessoNegado() {
        ...
        alert.setContentText("Apenas usuários ADMIN podem acessar o gerenciamento de usuários.");
        alert.showAndWait();
    }

    @FXML
    private void sair() {
        // ✅ LIMPA A SESSÃO ANTES DE SAIR
