...
public class ColmeiaCreateController {
    ...
    private void salvarColmeia() {
        try {
            ...
            if (colmeiaEditando == null) {
                // ✅ MODIFICADO: Nova colmeia inicializa com dados de rega
                Colmeia nova = new Colmeia(numero, local, tipo, situacao, data, numeroQuadros, obs);
                nova.setDataUltimaRega(LocalDate.now()); // ✅ NOVA LINHA
                nova.setStatusRega("NORMAL"); // ✅ NOVA LINHA
                ...
                // Edição mantém dados de rega existentes
